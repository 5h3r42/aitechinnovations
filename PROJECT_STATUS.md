...
- Deployed current `origin/main` (`10ba846`) directly to Hostinger on 2026-07-15 from a clean isolated worktree. The authoritative live root is `/home/u372008833/domains/aitechinnovations.com/public_html`; `/home/u372008833/public_html` is empty. Created `/home/u372008833/deployment-backups/aitechinnovations-public_html-20260715-144209.tar.gz` before a non-destructive rsync overlay. TypeScript, ESLint, 11 focused tests, the production build, all 22 static-route checks and `git diff --check` passed. Live QA confirmed four priority routes return 200, deployed checksums match, the approved £495 / £1,995 / £5,000 pricing and `pricing-spacer` markup are live, CTA bottoms align on desktop, cards stack at 768px and 390px, no overflow/console errors/broken images were found, required forms and scripts remain present, and `api/chatbot.php` returns a scripted 200 response.
